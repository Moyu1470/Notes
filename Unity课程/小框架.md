...
![image.png](https://cdn.jsdelivr.net/gh/Moyu1470/Notes/img/20260203192657141.png)

#### 5.【UI管理模块】进阶优化 异步加载问题解决 
...
![image.png](https://cdn.jsdelivr.net/gh/Moyu1470/Notes/img/20260203195758565.png)


#### 6.【UI管理模块】进阶优化 隐藏界面可选销毁

##### 知识点一 为什么要进行 隐藏面板可选销毁 优化 
...
![image.png](https://cdn.jsdelivr.net/gh/Moyu1470/Notes/img/20260203200954208.png)





#### 7.【UI管理模块】 进阶优化 自定义事件添加函数

##### 必备知识点 

- UGUI中 EventTrigger 相关知识点（UI四部曲之UGUI 中）

##### 知识点一 为什么要进行 自定义事件添加函数 优化 
...
![image.png](https://cdn.jsdelivr.net/gh/Moyu1470/Notes/img/20260203201449431.png)
...
- print(TextUtil.SecondToHMS(151323215)); 
- print(TextUtil.SecondToHMS(95328));

![image.png](https://cdn.jsdelivr.net/gh/Moyu1470/Notes/img/20260203122944046.png)


#### 7.【文本工具模块】 具体实现 秒转00:00:00

##### 知识点 实现文本工具类中的 秒转00:00:00 的方法 
- 我们上节课封装了 秒转时分秒的方法 
- 这节课 我们可以基于上节课代码进行修改 
- 提供一个 秒转00:00:00 的方法 
...
- print(TextUtil.SecondToHMS2(0)); 
- print(TextUtil.SecondToHMS2(60, true)); 
- print(TextUtil.SecondToHMS2(3600)); 
- print(TextUtil.SecondToHMS2(5416518)); 
- print(TextUtil.SecondToHMS2(85251)); 
  
- print(TextUtil.SecondToHMS2(5));

![image.png](https://cdn.jsdelivr.net/gh/Moyu1470/Notes/img/20260203123612382.png)

![image.png](https://cdn.jsdelivr.net/gh/Moyu1470/Notes/img/20260203123838077.png)


#### 8.【文本工具模块】 具体实现 大数据数值转字符串

##### 知识点 实现文本工具类中的 大数据数值转字符串 的方法 

- 为什么要封装 大数据数值转字符串 的方法 
...
![image.png](https://cdn.jsdelivr.net/gh/Moyu1470/Notes/img/20260203124144075.png)

#### 9.【数学计算工具模块】 主要作用和基本原理
...
#### 10.【数学计算工具模块】 角度和弧度的转换关系

##### 识点 实现数学计算工具类中的 角度和弧度相互转换 的方法 

- 为什么要封装 角度和弧度相互转换 的方法 
...
- float rad = MathUtil.Deg2Rad(60); 
- print(rad); 
- print(MathUtil.Rad2Deg(rad));

![image.png](https://cdn.jsdelivr.net/gh/Moyu1470/Notes/img/20260203143333921.png)
...
- 比如  
- 部分 2D游戏中，我们往往只关心 xy平面上的距离，z的变化不应该影响距离的计算 
- 部分 3D游戏中，我们往往只关心 xz平面上的距离，y的变化不应该影响距离的计算 
  
- 为了方便我们得到对象之间在某个平面的距离 
- 我们可以为其封装一些方法，专门用于计算 XZ、XY 平面上两点的距离 
...
-  print("两点间距离小于5"); 
- }
![image.png](https://cdn.jsdelivr.net/gh/Moyu1470/Notes/img/20260203153900359.png)
...
- 世界坐标转屏幕坐标 相关知识点 （Unity四部曲之Unity入门中）
#####  知识点 实现数学计算工具类中的 屏幕外判断 的方法 
...
![image.png](https://cdn.jsdelivr.net/gh/Moyu1470/Notes/img/20260203171924410.png)
...
- 向量点乘、叉乘 相关知识点（Unity四部曲之Unity基础中）

##### 知识点 实现数学计算工具类中的 扇形范围判断 的方法 

- 为什么要封装 扇形范围判断 的方法 
  
- 在进行游戏开发时 
- 我们经常需要判断目标是否在自己前方的扇形范围内 
- 用于触发下一步的行为，比如 触发攻击、触发伤害等等 
- 因此我们可以把 扇形范围判断 封装为一个方法 
- 方便外部使用 
  
- 需求： 
- 我们只需要实现判断XZ平面的扇形范围内即可 
...
![image.png](https://cdn.jsdelivr.net/gh/Moyu1470/Notes/img/20260203181945915.png)
```C#
/// <summary>  
...
##### 知识点 实现数学计算工具类中的 射线检测 相关方法 

- 为什么要封装 射线检测 相关方法 
  
- 射线检测是在游戏开发中经常会使用的功能 
- 我们完全可以基于Unity的射线检测进行二次封装 
- 让其使用起来更加的方便 
- 可以直接通过委托回调的形式对获取到的内容进行操作 
  
- 需求： 
- 通过委托回调的形式获取到射线检测得到的对象 
...
![image.png](https://cdn.jsdelivr.net/gh/Moyu1470/Notes/img/20260203185059762.png)
...
##### 知识点 实现数学计算工具类中的 范围检测 相关方法 

- 为什么要封装 范围检测 相关方法 
  
- 范围检测是在游戏开发中经常会使用的功能 
- 我们完全可以基于Unity的范围检测进行二次封装 
- 让其使用起来更加的方便 
- 可以直接通过委托回调的形式对获取到的内容进行操作 
...
![image.png](https://cdn.jsdelivr.net/gh/Moyu1470/Notes/img/20260203192337566.png)
...
/// <param name="layerMask">层级筛选</param>  
/// <param name="callBack">回调函数 </param>public static void OverlapBox<T>(Vector3 center, Quaternion rotation, Vector3 halfExtents, int layerMask, UnityAction<T> callBack) where T : class  
{  
    Type type = typeof(T);  
